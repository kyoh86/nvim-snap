...
local function wrap_html_diff(unified_diff, expected_plain, actual_plain, expected_aligned, actual_aligned)
  return table.concat({
    ...
    "    .tabs { display: flex; gap: 8px; align-items: center; padding: 12px 16px 0; }",
    "    .tabs label { padding: 6px 10px; border-radius: 6px; border: 1px solid #333; cursor: pointer; }",
    "    .tabs label:hover { border-color: #666; }",
    ...
    "      box-shadow: inset 0 0 0 9999px rgba(0,200,120,0.5), inset 0 0 0 1px rgba(0,200,120,0.8);",
    "      text-decoration: underline;",
    "      text-decoration-color: rgba(0,200,120,0.9);",
    "      text-decoration-thickness: 2px;",
    "      text-underline-offset: 0.12em;",
    "    }",
    "    #view-side-diff:checked ~ .page #side .view-aligned .cell.diff.removed {",
    "      box-shadow: inset 0 0 0 9999px rgba(220,70,70,0.5), inset 0 0 0 1px rgba(220,70,70,0.8);",
    "      text-decoration: underline;",
    "      text-decoration-color: rgba(220,70,70,0.95);",
    "      text-decoration-thickness: 2px;",
    "      text-underline-offset: 0.12em;",
    "    }",
    "    .udiff { color: #ddd; }",
